...
## 4. Сделать средства для прохождения тестов (В процессе):
✖ Добавить обработчик и шаблон для формы, в которой пользователь будет проходить тест.

✖ Добавить обработчик и шаблон для вывода результата за пройденный тест.

✖ Добавить фильтрацию по типу теста на основной странице сайта для более быстрого поиска.
## 5. Улучшение дизайна сайта (Не выполнено):
✖ Если получиться, выбрать более эстетичный и красивый шрифт для сайта.

✖ Поработать над размерами некоторых элементов сайта и привести их в адекватные рамки.
