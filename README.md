...
## 5. Улучшение дизайна сайта (В процессе):
✖ Если получиться, выбрать более эстетичный и красивый шрифт для сайта.

✖ В целом улучшить стиль сайта, css-файлы, возможно, как-то переработать внешние детали.
## 6. Последние штрихи (Не выполнено):
✖ Сделать хостинг сайта.

✖ Помолиться за всех 26 апреля, прежде чем пойти на защиту.
## В дополнение (Если будет время и возможность):
- Решить проблему с хранением и получением картинок из БД. Добавить возможность добавлять обложки тестов и картинки для результатов.
- Добавить фильтрацию тестов по их типу на основной странице.
